...
try:
	...
	print(' [+] Your internet connection is not detected. Please check your quota. Greetings from Asmat');exit()
prox=open('.prox.txt','r').read().splitlines()
for xd in range(10000):
	a='Mozilla/5.0 (Linux; U; Android 10;'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d='Infinix X668C Build/SP1A.210812.016)'
	e=random.randrange(100, 9999)
	f='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0'
	g=random.randrange(1, 9)
	h=random.randrange(1, 4)
	i=random.randrange(1, 4)
	j=random.randrange(1, 4)
	k='Mobile Safari/537.3 Chrome/115.0.0.0'
	...
	g='AppleWebKit/601.2.4 (KHTML, like Gecko) Version/9.0.1 Chrome/'
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/asmat-off1/Updated-Asmat/blob/main/UserAgents.txt').text
		ua=open('.bbnew.txt','w')
